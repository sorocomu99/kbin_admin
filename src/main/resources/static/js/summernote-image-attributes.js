				...
				this.initialize = function () {
					...
					var body = ` <div class="row">
									<div class="form-group col-sm-4">
										<label class="note-form-label">가로</label>
										<input class="form-control note-input note-image-width" type="number" />
									</div>
									<div class="form-group col-sm-4">
										<label class="note-form-label">세로</label>
										<input class="form-control note-input note-image-height" type="number" />
									</div>
								</div>`;

					var footer = `<button href="#" class="btn btn-primary note-image-title-btn note-btn">적용</button>`;
