...
public class StringUtil extends StringUtils {
    ...
    /**
     * 파라미터가 null 이거나 공백이 있을 경우 ""로 return
     * @param value
     * @return
     */
    ...
    public static int strToInt(String value) {
        return parseIntStr(value, 0);
    }

    /**
     * Object를 int형으로 defaultValue는 0
     * @param value
     * @return
     */
     ...
     * @return
     */
    public static int parseObjToInt(Object value, int defaultValue) {
        String valueStr = replaceNull(value);

        return parseIntStr(valueStr, defaultValue);
    }

    /**
     * String을 int형으로 String이 숫자형식이 아니면 defaultValue return
     * @param value
     * @param defaultValue
     * @return
     */
    public static int parseIntStr(String value, int defaultValue) {
        int returnValue = 0;
        if (isNull(value)) {
    ...
    /**
     * String을 long형으로 defaultValue는 0
     * @param value
     * @return
     */
    ...
    /**
     * String을 long형으로 잘못된 데이타 일시 return은 default
     * @param value
     * @return
     */
    ...
    /**
     * 해당 Object가 String 또는 Integer 이면 true 아니면 false
     * @param obj
     * @return
     */
    private static boolean isStringInteger(Object obj) {
        boolean flag = false;
     ...
     * <textarea name=msg row=2- cols=53>xxxxxxx</textarea>
     *
     * 위와 같은 HTML 소스를 생성할때, xxxxxxx 부분의 문자열 중에서
     * 아래에 있는 몇가지 특별한 문자들을 변환해야 한다.
     * 만약 JSP 라면 미리 변환하여 HTML 전체 TAG를 만들거나, 혹은 아래처럼 사용한다.
     *
     ...
     *
     * 또 필요하다면 yyyyyyy 부분도 translate(s)를 할 필요가 있다
     * 필요할 때 마다 사용한다.
     *
     * </xmp>
     *
     * @param str java.lang.String
     * @return then translated string
     */
